...
selection=1;
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            gameStatus.append(" Hit 'Play' to start again Your Score is "+score);
            score=0;
        }
        return true;
    }
